use crate::testing::metrics::aggregate::efficiency::memory::{MemoryEfficiency, MemoryRating};
use crate::testing::metrics::aggregate::efficiency::rating::EfficiencyRating;
use crate::testing::metrics::aggregate::efficiency::scalability::ScalabilityAssessment;
use eyre::Result;
