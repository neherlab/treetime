...
mod tests {
  ...
  fn test_coefficient_boundary_disjoint_support_zero_at_t0() {
    ...
    let metrics = evaluate_dense_contribution(&contribution, 0.1, true).expect("valid branch length");
    assert!(
  ...
  mod prop_tests {
    ...
    proptest! {
      ...
      fn test_prop_coefficient_additivity(
        ...
        let metrics_combined = evaluate_dense_contribution(&contrib_combined, branch_length, true).expect("valid branch length");
      ...
      fn test_prop_coefficient_dense_finite_difference_derivative(
        ...
        let lh_plus = evaluate_dense_contribution(&contribution, branch_length + h, true).expect("valid branch length").log_lh.value();
        let lh_minus = evaluate_dense_contribution(&contribution, branch_length - h, true).expect("valid branch length").log_lh.value();
      ...
      fn test_prop_coefficient_dense_hessian_matches_d1_finite_difference(
        ...
        let h = 1e-4;
        let d1_plus = evaluate_dense_contribution(&contribution, branch_length + h, true).expect("valid branch length").derivative;
        let d1_minus = evaluate_dense_contribution(&contribution, branch_length - h, true).expect("valid branch length").derivative;
  ...
  mod cancellation_regime {
    ...
    fn test_hessian_stable_in_cancellation_regime(#[case] epsilon: f64) {
      ...
      let h = 1e-6;
      let d1_plus = evaluate_sparse_contribution(&contribution, branch_length + h, true).expect("valid branch length").derivative;
      let d1_minus = evaluate_sparse_contribution(&contribution, branch_length - h, true).expect("valid branch length").derivative;
