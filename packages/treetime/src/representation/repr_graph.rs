...
impl ReprNode {
  pub fn new(name: Option<String>, desc: Option<String>, partitions: Vec<NodePartition>) -> Self {
  ...
  pub fn partition_at(&self, index: usize) -> &NodePartition {
...
impl ReprEdge {
  pub fn new(branch_length: Option<f64>, partitions: Vec<EdgePartition>) -> Self {
    Self {
      branch_length,
      partitions,
    }
