...
pub(super) fn prop_assert_columns_sum_to(
  matrix: &Array2<f64>,
  expected: f64,
  epsilon: f64,
...
pub(super) fn prop_assert_rows_sum_to(matrix: &Array2<f64>, expected: f64, epsilon: f64) -> Result<(), TestCaseError> {
...
pub(super) fn prop_assert_detailed_balance(
  q: &Array2<f64>,
  pi: &Array1<f64>,
  epsilon: f64,
) -> Result<(), TestCaseError> {
