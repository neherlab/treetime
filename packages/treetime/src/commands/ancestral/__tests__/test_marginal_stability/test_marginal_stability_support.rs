...
pub(super) fn assert_dense_profile_stable(profile: &DenseSeqDis, max_ulps: u32) {
  assert!(
...
pub(super) fn assert_sparse_profile_stable(profile: &MarginalSparseSeqDistribution, max_ulps: u32) {
  assert!(
    profile.log_lh.is_finite(),
    "Profile log_lh is not finite: {}",
    profile.log_lh
...
pub(super) fn run_dense_marginal_with_partitions(
  newick: &str,
  aln_str: &str,
  gtr: GTR,
...
pub(super) fn run_sparse_marginal_with_partitions(
  newick: &str,
  aln_str: &str,
  gtr: GTR,
