...
pub(super) fn analytical_two_taxon_likelihood(gtr: &GTR, obs_a: usize, obs_b: usize, t1: f64, t2: f64) -> f64 {
...
pub(super) fn analytical_star_tree_likelihood(gtr: &GTR, observations: &[usize], t: f64) -> f64 {
...
pub(super) fn analytical_three_taxon_likelihood(
  gtr: &GTR,
  obs_a: usize,
  obs_b: usize,
  obs_c: usize,
...
pub(super) fn state_index(c: char) -> usize {
  match c {
    'A' => 0,
    'C' => 1,
    'G' => 2,
...
/// `initialize_marginal`.
pub(super) fn run_dense_marginal_get_log_lh(newick: &str, aln_str: &str, gtr: GTR) -> Result<f64, Report> {
