...
pub(super) fn make_dense_contribution(coefficients: Array2<f64>) -> OptimizationContribution {
...
pub(super) fn grid_search(contributions: &[OptimizationContribution], branch_length: f64, one_mutation: f64) -> f64 {
