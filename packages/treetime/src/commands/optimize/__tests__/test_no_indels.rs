...
mod tests {
  ...
  use crate::commands::optimize::args::{BranchOptMethod, InitialGuessMode};
  use crate::commands::optimize::optimize_unified::run_optimize_mixed_inner;
  use crate::commands::optimize::run::{apply_initial_guess_mode, run_optimize_loop};
