...
pub fn create_exponential_test_cases() -> Vec<ExponentialTestCase> {
  vec![
    ExponentialTestCase {
      ...
      description: "Baseline with distinct rates (matches pdf example). General correctness, causal support, finite domains.".to_owned(),
    ...
    ExponentialTestCase {
      ...
      description: "Near-equal rates, cancellation sensitive. Numerical stability around a≈b; sensitivity to expm1-style evaluation.".to_owned(),
    ...
    ExponentialTestCase {
      ...
      description: "Fast plus slow decay with wide dynamic range. Interaction of very fast and very slow decays; long-tail coverage.".to_owned(),
    ...
    ExponentialTestCase {
      ...
      description: "Slow plus fast decay swapping roles. Symmetry under role swap; causal truncation interaction.".to_owned(),
    ...
    ExponentialTestCase {
      ...
      description: "High-accuracy fine grid reference baseline. Useful for regression against the coarse grid scenario.".to_owned(),
    ...
    ExponentialTestCase {
      ...
      description: "Large x range with near-underflow guard. Stability across wide index ranges; causal support check.".to_owned(),
    ...
    ExponentialTestCase {
      ...
      description: "Extreme near equality at machine epsilon scale. Robustness using expm1 and stable division.".to_owned(),
