...
pub fn create_gaussian_test_cases() -> Vec<GaussianTestCase> {
  vec![
    GaussianTestCase {
      ...
      description: "Baseline scenario with moderate widths; general correctness with asymmetric widths and shift.".to_owned(),
    ...
    GaussianTestCase {
      ...
      description: "Sharp g with small shift; sensitivity to sub-grid shifts and near-delta kernel behavior.".to_owned(),
    ...
    GaussianTestCase {
      ...
      description: "Very wide g with negative shift; robustness to ultra-broad kernel tails and translation.".to_owned(),
    ...
    GaussianTestCase {
      ...
      description: "Extreme width ratio with g much wider than f; convolution where g is nearly constant over f's support.".to_owned(),
    ...
    GaussianTestCase {
      ...
      description: "Tiny shift with equal widths; sensitivity to small translations and symmetry properties.".to_owned(),
