...
if __name__ == '__main__':
    ...
    if master:
        ...
        plt.figure()
        plt.plot(
            output_comparison[1][output_comparison[1]['bad_branch'] == 0].time,
            output_comparison[1][output_comparison[1]['bad_branch'] == 0].difference,
            'o',
        )
    ...
    if master:
        ...
        for name, group in groups:
            plt.plot(
                output_comparison[1].time,
                output_comparison[1].difference,
                marker='o',
                color=color[int(name)],
                linestyle='',
                ms=1,
                label=name,
            )
