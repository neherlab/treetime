...
fn test_outer_product_case_1() {
  ...
  let expected_outer_pi_ti = array![
    [0.495000005, 0.7362500075, 0.628750005, 0.660000005],
    [0.495000005, 0.7362500075, 0.628750005, 0.660000005],
    [0.495000005, 0.7362500075, 0.628750005, 0.660000005],
    [0.495000005, 0.7362500075, 0.628750005, 0.660000005],
  ];
  let expected_outer_ti_pi = array![
    [0.495000005, 0.495000005, 0.495000005, 0.495000005],
    [0.7362500075, 0.7362500075, 0.7362500075, 0.7362500075],
    [0.628750005, 0.628750005, 0.628750005, 0.628750005],
    [0.660000005, 0.660000005, 0.660000005, 0.660000005],
  ];
...
fn test_outer_product_case_2() {
  ...
  let ti = array![1.98000002, 2.94500003, 2.51500002, 2.64000002];
  let expected_outer_pi_ti = array![
    [0.29449037277465023, 0.43801724641197537, 0.3740622656246502, 0.3926538293746502],
    [0.4761954894100554, 0.7082806648650831, 0.6048644713600554, 0.6349273176100554],
    [0.6184000016464647, 0.9197919217196969, 0.7854929296964647, 0.8245333334464646],
    [0.5909141363688296, 0.8789101675532444, 0.7505803281688296, 0.7878855131688296],
  ];
  let expected_outer_ti_pi = array![
    [0.29449037277465023, 0.4761954894100554, 0.6184000016464647, 0.5909141363688296],
    [0.43801724641197537, 0.7082806648650831, 0.9197919217196969, 0.8789101675532444],
    [0.3740622656246502, 0.6048644713600554, 0.7854929296964647, 0.7505803281688296],
    [0.3926538293746502, 0.6349273176100554, 0.8245333334464646, 0.7878855131688296],
  ];
  let result_outer_pi_ti = outer(&pi, &ti).unwrap();
  let result_outer_ti_pi = outer(&ti, &pi).unwrap();
  pretty_assert_ulps_eq!(expected_outer_pi_ti, result_outer_pi_ti, max_ulps = 4);
