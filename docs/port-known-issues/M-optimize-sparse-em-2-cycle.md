...
The worsened condition with revert ensures the output always reflects the best observed state. This is similar to IQ-TREE's per-round monotonicity check with rollback <a id="cite-3"></a>([Minh et al. 2020](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7182206/) [[3](#ref-3)]).
...
3. <a id="ref-3"></a> Minh, B. Q., H. A. Schmidt, O. Chernomor, D. Schrempf, M. D. Woodhams, A. von Haeseler, and R. Lanfear. 2020. "IQ-TREE 2: New Models and Efficient Methods for Phylogenetic Inference in the Genomic Era." _Molecular Biology and Evolution_ 37 (5): 1530-1534. [doi:10.1093/molbev/msaa015](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7182206/) [↩](#cite-3)
4. <a id="ref-4"></a> Wu, C. F. Jeff. 1983. "On the Convergence Properties of the EM Algorithm." _The Annals of Statistics_ 11 (1): 95-103. [doi:10.1214/aos/1176346060](https://projecteuclid.org/journals/annals-of-statistics/volume-11/issue-1/On-the-Convergence-Properties-of-the-EM-Algorithm/10.1214/aos/1176346060.full) [↩](#cite-4)
