...
4. Support explicit name mapping via config file (see [config-file-multi-partition proposal](../port-proposals/config-file-multi-partition.md))
...
- [Configuration file format for multi-partition analysis](../port-proposals/config-file-multi-partition.md) - could include explicit name mappings
