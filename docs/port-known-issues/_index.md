...
| ~~Negligible~~ | ~~Optimize~~ | ~~Initial branch length guess always overwrites input values~~ **FIXED**                                                        |
...
| Negligible     | Optimize     | [Auto mode initial guess overwrites all edges](N-optimize-initial-guess-overwrites-all-edges.md)                                |
| Negligible     | Optimize     | [Integration test missing for initial guess mode dispatch](N-optimize-initial-guess-integration-test-missing.md)                |
