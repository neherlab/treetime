...
The Kingman coalescent neg-log-likelihood decomposes into three per-node pieces via algebraic telescoping of branch survival integrals (see [algo inventory](../port-algo-inventory/timetree.md#kingman-coalescent)):
...
- [Coalescent likelihood always returns None](M-timetree-coalescent-likelihood-stub.md) - the total coalescent likelihood stub also needs leaf and root terms to be complete
