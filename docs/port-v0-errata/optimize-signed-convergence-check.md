...
- The EM convergence theorem (<a id="cite-2"></a>[Wu 1983](https://doi.org/10.1214/aos/1176346060) [[2](#ref-2)], Theorem 2) proves monotone likelihood increase for the standard EM algorithm. The damped variant does not satisfy the theorem's conditions (the M-step does not maximize the Q-function), but the practical monotonicity observation in v0 is consistent with the analysis by <a id="cite-3"></a>[Polyak and Tremba (2019)](https://doi.org/10.1080/10556788.2019.1669154) [[3](#ref-3)] that damped Newton retains monotone progress when the damping factor is close to 1.
...
- <a id="ref-2"></a>Wu, C. F. Jeff. 1983. "On the Convergence Properties of the EM Algorithm." _The Annals of Statistics_ 11 (1): 95-103. https://doi.org/10.1214/aos/1176346060 [↩](#cite-2)
- <a id="ref-3"></a>Polyak, B. T., and A. A. Tremba. 2019. "New Versions of Newton Method: Step-size Choice, Convergence Domain and Under-determined Equations." _Optimization Methods and Software_ 35 (6): 1272-1303. https://doi.org/10.1080/10556788.2019.1669154 [↩](#cite-3)
