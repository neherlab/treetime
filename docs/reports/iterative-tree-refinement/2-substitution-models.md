...
[Back to index](_index.md) | Previous: [Chapter 1: Introduction](1-introduction.md) | Next: [Chapter 3: Tree likelihood](3-tree-likelihood.md)
...
GTR was formulated independently by Lanave et al. (1984) and given its mathematical framework by Tavare (1986).
