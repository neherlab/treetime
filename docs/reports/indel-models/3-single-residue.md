...
[Back to index](_index.md) | Previous: [Chapter 2: Gap treatment and counting models](2-gap-treatment.md) | Next: [Chapter 4: Multi-residue extensions and approximations](4-multi-residue.md)
