...
| Mugration  | [Pseudo-count smoothing on initial pi](mugration-pseudo-count-initial-pi.md#pseudo-count-smoothing-on-initial-pi)                                               | Smoother prior for first reconstruction              |
| Mugration  | [Root state uniform-threshold filtering](mugration-root-state-filtering.md#root-state-uniform-threshold-filtering)                                              | Avoids state-order bias at uninformative root        |
