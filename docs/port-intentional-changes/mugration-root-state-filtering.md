...
v1 skips the root state contribution to equilibrium frequency estimation when the root posterior profile is near-uniform at [packages/treetime/src/commands/mugration/gtr_refinement.rs#L144-L150](../../packages/treetime/src/commands/mugration/gtr_refinement.rs#L144-L150). A root profile with max probability at or below `1/n_states + 1e-10` carries no phylogenetic signal and is excluded.
