...
- GTR inference from sparse mutation counts does not account for per-site rates (a separate issue tracked in `docs/port-known-issues/M-gtr-per-site-rate-variation.md`).
