...
| Inference contracts                | 1      | 17      | Parameterized |
...
| `test_reconstruction_changes_composition_for_ambiguous_input` | Reconstruction changes Ti/root_state for ambiguous input |
