...
| Optimize  | [Model-aware zero-branch shortcut](optimize-model-aware-zero-branch-shortcut.md)                                                                                 | Restrict derivative-sign shortcut to models with proven unimodality |
