...
| Optimize  | ~~Model-aware zero-branch shortcut~~ → [implemented](../port-intentional-changes/optimize-model-aware-zero-branch-shortcut.md)                                   | Restrict derivative shortcut to unimodal models                   |
