...
Subsample of `rsv/a/500` (100 sequences).
...
Date range: 1956.50 - 2024.11

## Provenance

Source checksums (MD5, first 12 chars):
- aln.fasta.xz: 355a21610f75
- metadata.tsv: 8f3b2a8aeb9f
...
```bash
./dev/docker/run python3 data/subsample rsv/a/100
```
