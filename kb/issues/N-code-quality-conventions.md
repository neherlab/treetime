...
1. `gtr/infer_gtr/common.rs:100-129:` triple-nested loop replaceable by `sum_axis()`
2. `gtr/infer_gtr/common.rs:59-79:` manual outer product
...
6. `packages/treetime-grid/src/grid_fn.rs:397-401:` manual swap loop instead of `reverse_inplace()`
...
`packages/treetime/src/timetree/optimization/polytomy.rs:265:`
...
`packages/treetime/src/optimize/method_brent.rs`
...
`packages/treetime/src/timetree/optimization/polytomy.rs:216:`
...
4. `clock/run.rs:64:` TODO: empirical overdispersion value
5. `packages/treetime-grid/src/grid_fn.rs:180:` TODO: remove inefficient method
