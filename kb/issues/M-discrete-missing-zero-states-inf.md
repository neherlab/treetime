# Discrete partition uniform_profile(0) produces inf-filled profile

`uniform_profile(n_states)` at [packages/treetime/src/partition/marginal_discrete.rs#L165](../../packages/treetime/src/partition/marginal_discrete.rs#L165) computes `1.0 / n_states as f64` to build a uniform prior profile. When `n_states == 0`, this evaluates to `1.0 / 0.0 = inf`, producing an `Array2` filled with `inf` values.
