...
3. treat_gap_as_unknown interaction. Dense assigns uniform profiles to gap positions via `seq2prof()` (comment at [packages/treetime/src/partition/marginal_dense.rs#L91-L93](../../packages/treetime/src/partition/marginal_dense.rs#L91-L93)). Verify explicit unknown tracking does not conflict
