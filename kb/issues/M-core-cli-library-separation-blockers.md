...
Resolved: `run_optimize_mixed_inner`, `run_optimize_mixed_with_indel_rate`, `evaluate_with_indels_log_lh_only`, `evaluate_with_indels` promoted to `pub`. Internal helpers narrowed to `pub(super)` or private.
