...
- [Command-relationships report](../reports/command-relationships/README.md) -- describes the ideal `topology_cleanup` module containing `collapse_edge()`, `prune_short_branches()`, and `merge_shared_mutations()`.
