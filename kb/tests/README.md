...
| `test_gm_runner_marginal_dense`                        | [`test_gm_runner_marginal_dense.rs`](../../packages/treetime/src/commands/timetree/inference/__tests__/test_gm_runner/test_gm_runner_marginal_dense.rs)   | Dense-vs-v0 discrepancy: 0.92 years at root-adjacent node (grid-width)             |
...
| 1e-6      | `test_gm_runner_marginal_dense`                    | [`test_gm_runner_marginal_dense.rs`](../../packages/treetime/src/commands/timetree/inference/__tests__/test_gm_runner/test_gm_runner_marginal_dense.rs)            | Target tolerance (test ignored pending grid fix)      |
...
- [Test quality deficiencies](../issues/N-test-quality-deficiencies.md): missing pretty_assertions (46+ instances), loop-over-cases anti-pattern (21 files), circular tests, weak assertions, grossly loose tolerances (epsilon = 10.0, 1e0), helper placement violations
