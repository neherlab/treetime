...
The chi-squared distortion affects `find_best_root` ranking at [packages/treetime/src/clock/find_best_root/find_best_root.rs#L64-L78](../../packages/treetime/src/clock/find_best_root/find_best_root.rs#L64-L78), where the root with the lowest chi-squared is selected. Trees with many `bad_branch` leaves will have systematically inflated chi-squared values, selecting a suboptimal root.
