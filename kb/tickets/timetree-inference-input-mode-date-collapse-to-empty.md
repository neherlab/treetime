...
- Source: [kb/issues/M-timetree-inference-input-mode-date-collapse.md](../issues/M-timetree-inference-input-mode-date-collapse.md) -- delete after full resolution
