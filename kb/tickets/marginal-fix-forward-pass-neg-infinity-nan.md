# Fix marginal forward pass NEG_INFINITY producing NaN
...
- Source: [M-marginal-forward-pass-neg-infinity-nan.md](../issues/M-marginal-forward-pass-neg-infinity-nan.md) -- delete after full resolution
