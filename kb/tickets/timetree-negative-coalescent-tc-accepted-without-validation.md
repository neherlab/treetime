...
`--coalescent=-1.0` is accepted by clap and runs without error, producing tip-only annotations on flu/h3n2/20. v0 crashes with NaN/log errors from the negative Tc.
