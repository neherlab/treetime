# Wire multi-segment genome input
...
- Source: [N-io-multi-segment-genome-input.md](../issues/N-io-multi-segment-genome-input.md) -- delete after full resolution
- [M-io-sequence-name-matching-unreliable.md](../issues/M-io-sequence-name-matching-unreliable.md) -- name matching affects multi-segment attachment
- [M-io-sequence-attachment-quadratic.md](../issues/M-io-sequence-attachment-quadratic.md) -- attachment performance with multiple segments
- [io-large-dataset-memory-constraint](io-large-dataset-memory-constraint.md) -- memory constraints compound with multiple segments
- [config-file-multi-partition.md](../proposals/config-file-multi-partition.md) -- configuration file format that would subsume per-segment CLI flags
- [unified-input-format-support.md](../proposals/unified-input-format-support.md) -- alternative input via formats with embedded sequences
- [sequence_evolution.md](../_raw/sequence_evolution.md) -- source of the multi-segment requirement
