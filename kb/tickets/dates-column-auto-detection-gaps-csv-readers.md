...
- Source: [M-dates-column-auto-detection-gaps.md](../issues/M-dates-column-auto-detection-gaps.md) -- delete after full resolution
- [M-timetree-date-header-hash.md](../issues/M-timetree-date-header-hash.md) -- related `#`-stripping interaction with `--name-column` argument
