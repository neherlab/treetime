...
The argmax error is bounded by dx/2 = 3e-4 subs/site = 0.1 years per branch.
Errors accumulate through the tree: golden master tests comparing v1 against
v0 require 1.0-year tolerance, with the worst-case node (root-adjacent) differing
by 0.92 years. Validation RMSE across all nodes is 0.091 years.
