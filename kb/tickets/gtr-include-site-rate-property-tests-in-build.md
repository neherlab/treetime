# Include GTR site-rate property tests in build
...
- Source: [M-gtr-site-rates-tests-excluded.md](../issues/M-gtr-site-rates-tests-excluded.md) -- delete after full resolution
