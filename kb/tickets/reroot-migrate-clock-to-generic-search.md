...
- Preserve the fixed-zero-rate MinDev objective and the current tip-name resolution behavior.
...
- Reference scoring defect: [kb/v0-errata/clock-min-dev-fixed-slope-score.md](../v0-errata/clock-min-dev-fixed-slope-score.md)
