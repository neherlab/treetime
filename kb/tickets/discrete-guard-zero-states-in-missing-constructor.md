# Guard zero states in DiscreteNodeData::missing() constructor
...
- Source: [M-discrete-missing-zero-states-inf.md](../issues/M-discrete-missing-zero-states-inf.md) -- delete after full resolution
