...
| Ancestral | [Per-gene amino acid reconstruction for node data JSON](node-data-json-aa-reconstruction.md)                                              | AA mutations, root sequences, gene annotations in node data JSON  |
