...
| I/O       | [Output format selection for tree-writing commands](output-format-selection.md)                                                                  | Three-tier output: format enum with NWK style variants, per-file flags, selection filter |
