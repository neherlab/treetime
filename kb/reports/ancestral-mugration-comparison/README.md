...
Companion to [Command relationships: ancestral, prune, optimize, timetree](../command-relationships/README.md), which covers the four tree-refinement commands. That report does not include mugration. This report fills that gap.
...
The [command-relationships report](../command-relationships/README.md) identifies `ancestral` as the shared foundation for `prune`, `optimize`, and `timetree`. Mugration is outside this hierarchy entirely:
