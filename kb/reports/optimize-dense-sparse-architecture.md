...
Implemented by struct `PartitionMarginalSparse` [representation/partition/marginal_sparse.rs#L29](../../packages/treetime/src/representation/partition/marginal_sparse.rs#L29) ([impl](../../packages/treetime/src/representation/partition/marginal_sparse.rs#L293)) and struct `PartitionMarginalDense` [representation/partition/marginal_dense.rs#L31](../../packages/treetime/src/representation/partition/marginal_dense.rs#L31) ([impl](../../packages/treetime/src/representation/partition/marginal_dense.rs#L131)). Each delegates to fn `OptimizationContribution::from_sparse()` [commands/optimize/optimize_unified.rs#L120](../../packages/treetime/src/commands/optimize/optimize_unified.rs#L120) or fn `OptimizationContribution::from_dense()` [commands/optimize/optimize_unified.rs#L106](../../packages/treetime/src/commands/optimize/optimize_unified.rs#L106).

Extends trait `PartitionBranchOps` [representation/partition/traits.rs#L81](../../packages/treetime/src/representation/partition/traits.rs#L81) (fn `edge_subs()` [representation/partition/traits.rs#L91](../../packages/treetime/src/representation/partition/traits.rs#L91), fn `edge_effective_length()` [representation/partition/traits.rs#L95](../../packages/treetime/src/representation/partition/traits.rs#L95), fn `sequence_length()` [representation/partition/traits.rs#L83](../../packages/treetime/src/representation/partition/traits.rs#L83) - used by fn `initial_guess_mixed()` [commands/optimize/optimize_unified.rs#L729](../../packages/treetime/src/commands/optimize/optimize_unified.rs#L729)).
...
fn `OptimizationContribution::from_dense()` [commands/optimize/optimize_unified.rs#L106](../../packages/treetime/src/commands/optimize/optimize_unified.rs#L106) returns `Self`. fn `OptimizationContribution::from_sparse()` [commands/optimize/optimize_unified.rs#L120](../../packages/treetime/src/commands/optimize/optimize_unified.rs#L120) returns `Result<Self, Report>`. The sparse side can fail because it looks up variable positions via `ok_or_eyre()` [commands/optimize/optimize_sparse.rs#L74](../../packages/treetime/src/commands/optimize/optimize_sparse.rs#L74). This forces trait `PartitionOptimizeOps::create_edge_contribution()` [commands/optimize/partition_ops.rs#L15](../../packages/treetime/src/commands/optimize/partition_ops.rs#L15) to return `Result`, and the dense impl wraps its infallible value in `Ok()` [representation/partition/marginal_dense.rs#L136](../../packages/treetime/src/representation/partition/marginal_dense.rs#L136).
