...
- [Intentional change](../../decisions/optimize-indel-contribution-to-likelihood.md)
- [Alternatives proposal](../../proposals/optimize-indel-model-alternatives.md)
