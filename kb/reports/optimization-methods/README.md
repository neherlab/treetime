...
Companion to [Iterative tree refinement](../iterative-tree-refinement/README.md), which covers the pipeline architecture. This book focuses on the optimization algorithms themselves.
