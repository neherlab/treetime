...
The fact that `gtr.mu` is currently fixed in our codebase is a simplification, not a principled modeling choice. The convergence proposal [do../proposals/optimize-convergence-and-robustness.md](../proposals/optimize-convergence-and-robustness.md) already identifies GTR re-estimation as a missing feature (P9), matching v0's `infer_gtr` parameter and the behavior of <a id="cite-2b"></a>[PhyML](https://doi.org/10.1080/10635150390235520) [[2](#ref-2)], RAxML-NG, and IQ-TREE.
