...
- `fn chain_fitch_indels()` on `SparseEdgePartition` ([packages/treetime/src/partition/sparse.rs](../../packages/treetime/src/partition/sparse.rs)), analogous to `fn chain_fitch_subs()`
