...
| [WLS Sufficient Stats](clock.md#wls-sufficient-statistics)                      | custom     | clock        | [`packages/treetime/src/commands/clock/clock_set.rs`](../../packages/treetime/src/commands/clock/clock_set.rs)                                         | complete      |
...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| Ancestral    | [`packages/treetime/src/commands/ancestral/`](../../packages/treetime/src/commands/ancestral/), [`packages/treetime/src/partition/marginal_*.rs`](../../packages/treetime/src/partition/)              | Fitch, Marginal ML                                            |
...
| Mugration    | [`packages/treetime/src/commands/mugration/`](../../packages/treetime/src/commands/mugration/), [`packages/treetime/src/partition/discrete.rs`](../../packages/treetime/src/partition/discrete.rs)     | Discrete marginal, GTR construction                           |
...
| Indel Models | [`packages/treetime/src/commands/optimize/optimize_indel.rs`](../../packages/treetime/src/commands/optimize/optimize_indel.rs)                                                                                                       | Poisson indel count (implemented); TKF91, PIP (unimplemented) |
